...
use crate::wayland_handler::{AppData, CaptureImage, WaylandUpdate};
...
impl ScreencopySession {
    pub fn new(
        ...
        let image_source = screencopy_state
            .toplevel_source_manager
            .as_ref()
            .unwrap()
            .create_source(&capture.source, qh, ());
...
impl ScreencopyHandler for AppData {
    ...
    fn ready(
        ...
        self.send_event(WaylandUpdate::ToplevelCapture(
